...
impl TaskContract {
    ...
    pub fn add_task(env: Env, title: String) -> String {
        ...
        return String::from_str(&env, "Task added successfully")
    }
    //Fungsi untuk menandai task sudah selsai
    pub fn complete_task(env: Env, id: u64) -> String {
        ...
        for i in 0..tasks.len() {
            ...
            if task.id == id {
                ...
                env.storage().instance().set(&TASK_DATA, &tasks);
                return String::from_str(&env, "Task completed");
            }
        }

        return String::from_str(&env, "Task not found")
    }
